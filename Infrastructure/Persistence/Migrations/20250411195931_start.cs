        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiSource = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_News_AppUsers_AuthorId",
                        column: x => x.AuthorId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CategoriresId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NewsListId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryNews", x => new { x.CategoriresId, x.NewsListId });
                    table.ForeignKey(
                        name: "FK_CategoryNews_Categories_CategoriresId",
                        column: x => x.CategoriresId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryNews_News_NewsListId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryNews_NewsListId",
                table: "CategoryNews",
                column: "NewsListId");
